...
namespace Util.Saving
{
    ...
    public class SerializableDictionary<TKey, TVal> : Dictionary<TKey, TVal>, IXmlSerializable, ISerializable
    {
        ...
        void IXmlSerializable.ReadXml(XmlReader reader)
        {
            ...
            // Move past container
            if (!reader.Read()) throw new XmlException("Error in Deserialization of Dictionary");
        ...
        protected XmlSerializer ValueSerializer
        {
            get
            {
                if (_valueSerializer == null) _valueSerializer = new XmlSerializer(typeof(TVal));
        ...
        private XmlSerializer KeySerializer
        {
            get
            {
                if (_keySerializer == null) _keySerializer = new XmlSerializer(typeof(TKey));
