...
namespace Managers
{
    ...
    public class WaveController : MonoBehaviour
    {
        ...
        private void Start()
        {
            if (!Serialization.TryLoadWave("Wave1", out var wave)) throw new FileLoadException("Could not load wave file!");
            Debug.Log(wave);
            ...
            {
                if (_patterns[(int)key.z] == null) _patterns[(int)key.z] = new Dictionary<Vector2, char>();
